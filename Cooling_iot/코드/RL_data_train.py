...
model = Sequential()
model.add(LSTM(256, return_sequences=True, input_shape=(20, 8)))
...
with tf.device("/device:gpu:0"):
    model.fit(x_train, y_train, validation_data=(x_test, y_test), batch_size=64, epochs=60)
#batch_size = 32로 고정
...
model.save('RL_train1_norm10.h5')
